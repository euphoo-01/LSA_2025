...
2.  **Адаптация лексического анализатора (`LexA`, `LT.h`, `FST`)**
    *   [x] Обновить определения токенов в `LT.h` в соответствии с лексемами LSA-2025.
    *   [x] Модифицировать или переписать конечные автоматы (FST) в `LexA.cpp`/`LexA.h` для распознавания ключевых слов LSA-2025: `unsigned`, `integer`, `char`, `logic`, `main`, `send`, `if`, `differ`, `because`, `func`.
    *   [x] Добавить распознавание операторов LSA-2025: `:`, `~`, `++`, `--`.
